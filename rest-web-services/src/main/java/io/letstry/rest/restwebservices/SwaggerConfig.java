package io.letstry.rest.restwebservices;
...
public class SwaggerConfig {
	...
	public static final Contact DEFAULT_CONTACT = new Contact("Abhilash R", "www.letstry.io",
			"smile_with_abhi@hotmail.com");
	public static final ApiInfo DEFAULT_API_INFO = new ApiInfo("LetsTry REST Service", "REST Api Documentation", "1.0",
